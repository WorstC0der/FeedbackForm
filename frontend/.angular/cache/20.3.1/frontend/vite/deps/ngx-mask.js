import {
  NG_VALIDATORS,
  NG_VALUE_ACCESSOR
} from "./chunk-77LEPX3V.js";
import "./chunk-4TPI4CB7.js";
...
var initialConfig = {
  ...
  inputTransformFn: /* @__PURE__ */ __name((value) => value, "inputTransformFn"),
  outputTransformFn: /* @__PURE__ */ __name((value) => value, "outputTransformFn"),
...
var _NgxMaskApplierService = class _NgxMaskApplierService {
  ...
  _formatWithSeparators = /* @__PURE__ */ __name((str, thousandSeparatorChar, decimalChars, precision) => {
    let x = [];
    let decimalChar = "";
  ...
  }, "_formatWithSeparators");
  percentage = /* @__PURE__ */ __name((str) => {
  ...
  getPrecision = /* @__PURE__ */ __name((maskExpression) => {
  ...
  checkAndRemoveSuffix = /* @__PURE__ */ __name((inputValue) => {
    ...
    return inputValue;
  }, "checkAndRemoveSuffix");
  checkInputPrecision = /* @__PURE__ */ __name((inputValue, precision, decimalMarker) => {
...
__name(_NgxMaskApplierService, "NgxMaskApplierService");
__publicField(_NgxMaskApplierService, "ɵfac", /* @__PURE__ */ __name(function NgxMaskApplierService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxMaskApplierService)();
}, "NgxMaskApplierService_Factory"));
__publicField(_NgxMaskApplierService, "ɵprov", ɵɵdefineInjectable({
...
__name(_NgxMaskService, "NgxMaskService");
__publicField(_NgxMaskService, "ɵfac", /* @__PURE__ */ (() => {
  let ɵNgxMaskService_BaseFactory;
  return /* @__PURE__ */ __name(function NgxMaskService_Factory(__ngFactoryType__) {
  ...
  }, "NgxMaskService_Factory");
})());
__publicField(_NgxMaskService, "ɵprov", ɵɵdefineInjectable({
...
__name(_configFactory, "_configFactory");
...
var _NgxMaskDirective = class _NgxMaskDirective {
  ...
  _areAllCharactersInEachStringSame(array) {
    ...
    __name(removeSpecialCharacters, "removeSpecialCharacters");
...
__name(_NgxMaskDirective, "NgxMaskDirective");
__publicField(_NgxMaskDirective, "ɵfac", /* @__PURE__ */ __name(function NgxMaskDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxMaskDirective)();
}, "NgxMaskDirective_Factory"));
__publicField(_NgxMaskDirective, "ɵdir", ɵɵdefineDirective({
  type: _NgxMaskDirective,
  selectors: [["input", "mask", ""], ["textarea", "mask", ""]],
  hostBindings: /* @__PURE__ */ __name(function NgxMaskDirective_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("paste", /* @__PURE__ */ __name(function NgxMaskDirective_paste_HostBindingHandler() {
        return ctx.onPaste();
      }, "NgxMaskDirective_paste_HostBindingHandler"))("focus", /* @__PURE__ */ __name(function NgxMaskDirective_focus_HostBindingHandler($event) {
        return ctx.onFocus($event);
      }, "NgxMaskDirective_focus_HostBindingHandler"))("ngModelChange", /* @__PURE__ */ __name(function NgxMaskDirective_ngModelChange_HostBindingHandler($event) {
        return ctx.onModelChange($event);
      }, "NgxMaskDirective_ngModelChange_HostBindingHandler"))("input", /* @__PURE__ */ __name(function NgxMaskDirective_input_HostBindingHandler($event) {
        return ctx.onInput($event);
      }, "NgxMaskDirective_input_HostBindingHandler"))("compositionstart", /* @__PURE__ */ __name(function NgxMaskDirective_compositionstart_HostBindingHandler($event) {
        return ctx.onCompositionStart($event);
      }, "NgxMaskDirective_compositionstart_HostBindingHandler"))("compositionend", /* @__PURE__ */ __name(function NgxMaskDirective_compositionend_HostBindingHandler($event) {
        return ctx.onCompositionEnd($event);
      }, "NgxMaskDirective_compositionend_HostBindingHandler"))("blur", /* @__PURE__ */ __name(function NgxMaskDirective_blur_HostBindingHandler($event) {
        return ctx.onBlur($event);
      }, "NgxMaskDirective_blur_HostBindingHandler"))("click", /* @__PURE__ */ __name(function NgxMaskDirective_click_HostBindingHandler($event) {
        return ctx.onClick($event);
      }, "NgxMaskDirective_click_HostBindingHandler"))("keydown", /* @__PURE__ */ __name(function NgxMaskDirective_keydown_HostBindingHandler($event) {
        return ctx.onKeyDown($event);
      }, "NgxMaskDirective_keydown_HostBindingHandler"));
    }
  }, "NgxMaskDirective_HostBindings"),
  inputs: {
    mask: [1, "mask"],
...
__name(_NgxMaskPipe, "NgxMaskPipe");
__publicField(_NgxMaskPipe, "ɵfac", /* @__PURE__ */ __name(function NgxMaskPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxMaskPipe)();
}, "NgxMaskPipe_Factory"));
__publicField(_NgxMaskPipe, "ɵpipe", ɵɵdefinePipe({
  name: "mask",
  type: _NgxMaskPipe,
  pure: true
}));
